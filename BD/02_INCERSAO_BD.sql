...
insert into Jogos values ('Diablo 3','é um jogo que contém bastante ação e é viciante','2012-05-15',99,2),
						('Read Dead Redemption 2','jogo eletrônico de ação-aventura western.','2018-10-26',120,3),
						('Horizon Chaise Turbo',' Jogo de corrida inspirado em outro jogo de corrida antigo','2016-05-02',45,4);
